    ...
    <template #header>
      <div class="flex items-center gap-3">
        <div
          ...
          :class="
            normalizedType === 'error' ? 'bg-error/10 text-error' : 'bg-primary/10 text-primary'
          "
        >
          <slot name="icon">
            <svg
              v-if="normalizedType === 'error'"
        ...
        <h3 class="text-lg font-semibold text-slate-100 leading-none">{{ props.title }}</h3>
      </div>
    </template>
