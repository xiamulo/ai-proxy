...
<template>
  <div class="flex items-center justify-between gap-3">
    <div>
      <h2 class="mtga-card-title text-white">应用设置</h2>
      <p class="mtga-card-subtitle text-slate-400">管理数据与系统配置</p>
    </div>
  ...
  <div class="mt-4 space-y-4">
    <div class="mtga-soft-panel space-y-3">
      <div>
        <div class="text-sm font-semibold text-slate-100">用户数据</div>
        <div class="text-xs text-slate-400">备份与恢复历史数据</div>
      </div>
      <div class="space-y-2">
        <button
        ...
        <button
          class="mtga-btn-primary w-full tooltip mtga-tooltip"
    ...
    <button class="mtga-clickable-row" @click="openThemeDialog">
      <span class="flex flex-col items-start gap-0.5 text-left">
        <span class="font-semibold text-slate-200">主题配置</span>
